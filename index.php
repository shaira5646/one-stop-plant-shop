...
?>
  ...
  <!-- Cover -->
  <main>
    <img class="box" src="images/photo_short.png" width="2450">
    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: One Stop Plant Shop.<br>
	    180-182 Mohakhali, Bangladesh.
          </address>
            <div class="phone">
              Telephone:
            ...
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">onestopplant@gmail.com</a>
            </div>
          </div>
      ...
      <!-- <div class="banners">
        <div class="container clearfix">
          ...
          <div class="banner-award">
            <span>Award winner</span><br> Green Planet 2022
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
                ...
                <div class="copyright">
                        &copy; <?php echo date("Y");?> One Stop Plant Shop&trade;
                </div>
		<div class="developer">
			Dev by Group 6
		</div>
